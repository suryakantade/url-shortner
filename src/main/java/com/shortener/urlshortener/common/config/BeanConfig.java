...
public class BeanConfig {
  ...
  public Map<ServiceType, UrlShortenerService> setUrlShortenerService(
      ...
      @Qualifier("com.shortener.urlshortener.v1.service.impl.UrlShortenerMongoServiceImpl")
      UrlShortenerMongoServiceImpl urlShortenerMongoServiceImpl){
    ...
    shortenerServiceMap.put(ServiceType.MONGO, urlShortenerMongoServiceImpl);
